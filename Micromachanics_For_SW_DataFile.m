...
smiData.RigidTransform(1).translation = [0.14046878338750959 0.080463786330433162 0.26621869330173475];  % mm
smiData.RigidTransform(1).angle = 0;  % rad
smiData.RigidTransform(1).axis = [0 0 0];
smiData.RigidTransform(1).ID = 'RootGround[Inter_Matrix_Spacer-1]';
...
smiData.Solid(1).mass = 4.3408030883063571e-10;  % kg
smiData.Solid(1).CoM = [-0.0014770266088113099 0.0025584334527334195 -0.0019693235508362137];  % in
smiData.Solid(1).MoI = [0 0 0];  % kg*in^2
smiData.Solid(1).PoI = [0 0 0];  % kg*in^2
smiData.Solid(1).color = [0.89803921568627454 0.91764705882352937 0.92941176470588238];
smiData.Solid(1).opacity = 1;
smiData.Solid(1).ID = 'Inter_Matrix_Spacer*:*Default';
